    ...
    return(
      <div className='champion-pic'>
        ...
        <div className='champion-rune-container'>
          ...
          <div className='sub-rune-container'><div className='champion-sub-rune'/></div>
        </div>
        <div className='spell-container'>
          <div className='spell-wrapper'><div className='spell loading'/></div>
          <div className='spell-wrapper' style={{marginLeft:'2px'}}><div className='spell loading'/></div>
        </div>
      </div>
      </div>
    )
    ...
    <div className='champion-pic'>
      ...
      <div className='rune-spell'>
        <div className='champion-rune-container'>
          ...
          <div className='sub-rune-container'><LazyImage className='champion-sub-rune' src={getSubRunePic()} /></div>
        </div>
        <div className='spell-container'>
          <div className='spell-wrapper'><LazyImage className='spell' src={getSummonerSpellPic()}/></div>
          <div className='spell-wrapper' style={{marginLeft:'2px'}}><LazyImage className='spell' src={getSummonerSpellPic()}/></div>
        </div>
      </div>
    </div>
  );
